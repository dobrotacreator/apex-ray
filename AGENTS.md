...
- `src/apex_ray/`: Python CLI, config loading, review pipeline, reports, telemetry, and LLM provider orchestration.
- `analyzers/typescript/src/`: bundled TypeScript/JavaScript analyzer that builds the context model used by reviews.
