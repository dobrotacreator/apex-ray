...
export const OrderEvent = {
  OPS_RECONCILED_LANDED_NO_CANCEL: 'OPS_RECONCILED_LANDED_NO_CANCEL',
  OPS_RECONCILED_LANDED_CANCEL: 'OPS_RECONCILED_LANDED_CANCEL',
  OPS_RECONCILED_LOST: 'OPS_RECONCILED_LOST',
} as const;
...
export const transitionOrder = createStateMachine<OrderStatus, OrderEvent>('order', [
  [OrderStatus.AWAITING_RECONCILIATION, OrderEvent.OPS_RECONCILED_LANDED_NO_CANCEL, OrderStatus.FAILED],
  [OrderStatus.AWAITING_RECONCILIATION, OrderEvent.OPS_RECONCILED_LANDED_CANCEL, OrderStatus.CANCELLED],
  [OrderStatus.AWAITING_RECONCILIATION, OrderEvent.OPS_RECONCILED_LOST, OrderStatus.FAILED],
]);
